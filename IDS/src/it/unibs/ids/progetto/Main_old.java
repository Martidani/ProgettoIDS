...
public class Main_old {
	...
	public final static String[] vociAccesso = 
		...
		private static Nodo root(Gerarchia gerarchia) {
			String radice;
			do {
		...
		private static void inserimentoFattori(Gerarchia gerarchia, ArrayList<Nodo> foglieAttuali) throws Exception {
			String foglia1;
			String radice1;
			String foglia2;
			String radice2;
